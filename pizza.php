        ...
        if ($nbr_food > 0) {
            ...
            foreach ($result as $row) {
                ...
                if ($produit_image == '') {
                    ...
                    echo ' <button class="accordion-button collapsed btn" type="button" data-bs-toggle="collapse" data-bs-target="#flush-accordionP' . $id_produit . '" aria-expanded="false" aria-controls="flush-accordionP' . $id_produit . '" style="background-color: #0a5846ab; color: #fff">' . $nom_produit . ' ' . $produit_prix . ' €' .
                        '</button>';
                    echo ' </h2>';
