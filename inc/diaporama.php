    ...
    <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
                <img src="img/pizza1.jpg" class="d-block w-100 img-curvy img-thumbnail img-responsive" alt="pizza" style="background-color:#28a745; border-color:#28a745;">
            </div>
            <div class="carousel-item" data-bs-interval="5000">
                <img src="img/sushi1.jpg" class="d-block w-100 img-curvy img-thumbnail img-responsive" alt="sushi" style="background-color:#28a745; border-color:#28a745;">
            </div>
        </div>
...
<div id="carouselAccueil" class="carousel slide carousel-fade bg-dark" data-bs-ride="carousel">
    <div class="carousel-indicators">
