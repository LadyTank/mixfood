            ...
            <div class="container col-sm-11 col-md-6 col-lg-3  navbar-collapse collapse justify-content-center">
                ...
                if (estConnecte()) { // si membre utilisateur connecté
                    if (estAdmin()) { // si le membre connecté est administrateur
                        echo '<a class="nav-link lienBlanc espace btn btn-success nav-item m-2 col-sm-12 col-md-6 col-xl-6 mt-4" href="profil_client.php">ADMIN</a>';
                    } else {
                        echo '<a class="nav-link lienBlanc espace btn btn-success nav-item m-2 m-2 col-sm-12 col-md-6 col-xl-6 mt-4" href="profil_client.php">PROFIL</a>';
                    }
                    echo '<a class="nav-link lienBlanc espace btn btn-danger nav-item m-2 col-sm-12 col-md-6 col-xl-6 mt-4" href="profil_client.php?action=deconnexion">Déconnexion</a>';
                } else { //sinon
                    echo '<a class="nav-link text-dark espace btn btn-light nav-item m-2 col-sm-12 col-md-6 col-xl-6  btn-I" href="inscription_client2.php">Inscription</a>';

                    echo '<a class="nav-link lienBlanc espace btn btn-success nav-item m-2 col-sm-12 col-md-6 col-xl-6 " href="connexion_client2.php">Connexion</a>';
                }
                ?>
            </div>
        </nav>
